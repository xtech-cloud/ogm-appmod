...
{
    public class BaseKeyUiBridge: IKeyUiBridge
    {
        public KeyControl control {get;set;}
        ...
        public virtual void ReceiveGenerate(string _json) 
        {
        ...
        public virtual void ReceiveActivate(string _json) 
        {
            Reply reply = JsonSerializer.Deserialize<Reply>(_json);
            if (reply.status.code == 0)
                Growl.Success("Success", "StatusGrowl");
